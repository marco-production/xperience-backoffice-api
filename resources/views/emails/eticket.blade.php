...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #f8fafc; color: #74787e; height: 100%; hyphens: auto; line-height: 1.4; margin: 0; -moz-hyphens: auto; -ms-word-break: break-all; width: 100% !important; -webkit-hyphens: auto; -webkit-text-size-adjust: none; word-break: break-word;">
        <style>
            ...
            .withBorder {border: 1px solid black;border-collapse: collapse; border-style:dotted;}
                    ...
                    <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                        <tr>
                            <td class="header" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 25px 0; text-align: center;">
                                <a href="https://xperiencedominicanrepublic.com/" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                                    <img src="{{asset('/images/global/xperience.png')}}" alt="Xperience logo" style="max-width: 70%; border: none;">
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td class="body" width="100%" cellpadding="0" cellspacing="0" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #ffffff; border-bottom: 1px solid #edeff2; border-top: 1px solid #edeff2; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                <table class="inner-body wrapper" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                    <tr>
                                        <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 20px 35px 20px 35px;text-align: center;">
                                            <h2 style="padding: 0 !important;margin: 0 !important;">@lang('eticket_pass')</h2>
                                            <p style="padding: 0 !important;margin: 0 !important;">@lang('boarding_disembarking')</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <table width="100%" cellpadding="0" cellspacing="0" class="container">
                                                <tr>
                                                    <td width="200" class="mobile" style="font-size:12px; line-height:18px;text-align: center;">
                                                        <img src="{{asset('/images/qrcodes/'.$eticket['qr_code'])}}" alt="QR code" style="width:160px !important;"/>
                                                        <h5>@lang('exclusive_use')</h5>
                                                    </td>
                                                    <td width="400" class="mobile" style="font-size:12px; line-height:18px;">
                                                        <table width="100%" class="withBorder" style="font-size: 13px;">
                                                            <tr class="withBorder">
                                                                <th class="withBorder">@lang('name'):</th>
                                                                <td class="withBorder">{{$eticket['name']}}</td>
                                                            </tr>
                                                            <tr class="withBorder">
                                                                <th class="withBorder">@lang('passport'):</th>
                                                                <td class="withBorder">{{$eticket['passport']}}</td>
                                                            </tr>
                                                            <tr class="withBorder">
                                                                <th class="withBorder">@lang('nationality'):</th>
                                                                <td class="withBorder">{{$eticket['nationality']}}</td>
                                                            </tr>
                                                            <tr class="withBorder">
                                                                <th class="withBorder">@lang('date_of_issue'):</th>
                                                                <td class="withBorder">{{$eticket['created_at']}}</td>
                                                            </tr>
                                                            <tr class="withBorder">
                                                                <th class="withBorder">@lang('migration'):</th>
                                                                <td class="withBorder">
                                                                    @if ($eticket['is_arrival'])
                                                                        @lang('entry')
                                                                    @else
                                                                        @lang('exit')
                                                                    @endif
                                    ...
                                    <tr>
                                        <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                            <p style="font-size: 12px;"><b>@lang('note')</b> @lang('email_generated_automatically')</p>
                                            <p style="font-size: 12px;">@lang('powered_by') <b>Xperience</b></p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; margin: 0 auto; padding: 0; text-align: center; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                    <tr>
                                        <td class="content-cell" align="center" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                            <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">Copyright &copy; {{ now()->year }} - @lang('all_rights_reserved')</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
